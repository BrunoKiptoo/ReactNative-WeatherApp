    ...
    <div>
      <div className="bg-gradient-to-br from-black to-indigo-900 text-white py-20">
        <div className="container mx-auto text-center">
          ...
          <button className="bg-purple-700 hover:bg-purple-800 text-white font-semibold py-3 px-8 rounded-lg">
            Get Started
          </button>
        </div>
      </div>
      <div className="container mx-auto py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Link to="/analytics" className="hover:bg-purple-800">
            <div className="bg-purple-900 text-white p-6 rounded-lg transition duration-300">
          ...
          <Link to="/map" className="hover:bg-purple-800">
            <div className="bg-purple-900 text-white p-6 rounded-lg transition duration-300">
              <h3 className="text-2xl font-semibold mb-4">Athlete Profiles</h3>
              <p className="mb-4">
                Discover talented athletes and their achievements.
              </p>
              <span className="text-purple-400 hover:text-purple-300">
                Learn More
              </span>
